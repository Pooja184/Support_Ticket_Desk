...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      <aside
        className={`
          fixed md:static top-0 left-0 h-full w-64 bg-white border-r p-4
      ...
      >
        ...
        {/* Navigation links */}
        <NavItem to="add-tickets" label="Add Tickets" onClick={onClose} />
        <NavItem to="my-tickets" label="My Tickets" onClick={onClose} />
